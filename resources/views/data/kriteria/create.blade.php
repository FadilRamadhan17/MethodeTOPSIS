                        ...
                        <form method="POST" action="{{ route('kriteria.store') }}">
                            ...
                            <div class="mb-6">
                                ...
                                <div class="flex items-start">
                                    <input id="benefit" type="radio" name="attribut" value="benefit"
                                        class="w-4 h-4 border rounded bg-gray-50 focus:ring-3 focus:ring-blue-300"
                                        required>
                                    <label for="benefit" class="ml-2 text-sm font-medium text-gray-900">Benefit</label>
                                </div>
                                <div class="flex items-start">
                                    <input id="cost" type="radio" name="attribut" value="cost"
                                        class="w-4 h-4 border rounded bg-gray-50 focus:ring-3 focus:ring-blue-300"
                                        required>
                                    <label for="cost" class="ml-2 text-sm font-medium text-gray-900">Cost</label>
                                </div>
                            </div>
